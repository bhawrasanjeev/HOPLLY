...
export const handleChat = async (req, res) => {
  try {
    ...
    let reply = "I'm here to help! Hoply connects you directly with background-checked local neighbors. You can post a task or accept open jobs instantly in your feed.";
    ...
    if (lower.includes('grocery')) {
      ...
      reply = "Safety is Hoply's top priority! All helpers undergo ID verification, local rating checks, and community reviews. Payments are safely held in escrow until you approve task completion.";
    } else if (lower.includes('price') || lower.includes('rate') || lower.includes('cost') || lower.includes('mow')) {
      reply = "Hoply Hyperlocal Rate Standards:\n- Grocery Pickup: Rs. 20 - Rs. 30\n- Handyman Repairs: Rs. 45 - Rs. 75/hr\n- Dog Walking: Rs. 15 - Rs. 25 (30 mins)\n- Deep Cleaning: Rs. 70 - Rs. 120";
    }
